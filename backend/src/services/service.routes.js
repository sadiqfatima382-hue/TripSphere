...
router.get("/my-services", authenticate, authorizePermission("services.read"), validate(serviceQuerySchema), getVendorServices);
router.get("/", authenticate, authorizePermission("services.read"), validate(serviceQuerySchema), getServices);
