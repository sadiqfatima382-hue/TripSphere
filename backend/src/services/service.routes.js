...
import { createService, getServiceById, getOwnService, getVendorServices, getServices, updateOwnService, deleteOwnService, submitOwnService, approveService, rejectService, suspendService } from "./service.controller.js";
...
router.patch("/:id/suspend", authenticate, authorizePermission("services.update"), suspendService);
